...
En este punto me [transfiero](/posts/transferirarchivos/) el archivo a mi máquina host montando un servidor con python en la máquina víctima (`python3 -m http.server 8080`) y con **wget** desde la máquina host me lo descargo (`wget 172.17.0.2/command_exec`).
